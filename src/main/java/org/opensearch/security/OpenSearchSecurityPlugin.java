...

{
    ...
    public OpenSearchSecurityPlugin(final Settings settings, final Path configPath) {
        ...
        //TODO TQ Support multiple providers?
        AccessController.doPrivileged((PrivilegedAction<Object>) () -> {
            //if (Security.getProvider("BC") == null) {
            System.out.println("TQ Providers: " + Security.getProviders().toString());
            if (Security.getProvider("BCFIPS") == null) {
                //Security.addProvider(new BouncyCastleProvider());
                System.out.println("TQ specifically add provider");
                Security.addProvider(new BouncyCastleFipsProvider());
                //new BouncyCastleJsseProvider()
                //public static final String PROVIDER_NAME = "BCJSSE";
            }
            else {
                System.out.println("TQ got BCFIPS provider");
            }
            return null;
        });
